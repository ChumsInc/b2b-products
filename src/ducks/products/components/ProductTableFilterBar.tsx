...
import {
    productListTableKey, selectCurrentProductChanged,
...
import {
    ...
    setFilterAvailableAction, setFilterOnSaleAction, setNewCurrentProductAction,
    setProductsSearchAction
} from "../actions";
import {FormCheck, setPageAction, SpinnerButton} from "chums-ducks";
...
const ProductTableFilterBar:React.FC = () => {
    ...
    return (
        <div className="row g-3 align-items-baseline">
            ...
            <div className="col-auto">
                <FormCheck label="Filter Active" checked={filterActive} onClick={filterActiveClickHandler} type={"checkbox"} />
            </div>
            <div className="col-auto">
                <FormCheck label="Filter On Sale" checked={filterOnSale} onClick={filterOnSaleClickHandler} type={"checkbox"} />
            </div>
            <div className="col-auto">
                <FormCheck label="Filter Available" checked={filterAvailable} onClick={filterAvailableClickHandler} type={"checkbox"} />
            </div>
            <div className="col-auto">
                <SpinnerButton spinning={loading} type="button" onClick={reloadHandler} size="sm">Reload</SpinnerButton>
            </div>
            <div className="col-auto">
                <button type="button" className="btn btn-sm btn-outline-secondary" onClick={newProductHandler}>New Product</button>
            </div>
        </div>
    )
}
